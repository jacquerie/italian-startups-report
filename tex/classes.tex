...
\begin{document}
  \begin{tikzpicture}
    ...
    \node (AA-data) at (1.5,5.5) [] {\(674\)};
    \node (AB-data) at (2.5,5.5) [] {\(46\)};
    \node (AC-data) at (3.5,5.5) [] {\(6\)};
    \node (AD-data) at (4.5,5.5) [] {};
    \node (AE-data) at (5.5,5.5) [] {};

    \node (BA-data) at (1.5,4.5) [] {\(386\)};
    \node (BB-data) at (2.5,4.5) [] {\(88\)};
    \node (BC-data) at (3.5,4.5) [] {\(19\)};
    \node (BD-data) at (4.5,4.5) [] {};
    \node (BE-data) at (5.5,4.5) [] {};

    \node (CA-data) at (1.5,3.5) [] {\(32\)};
    \node (CB-data) at (2.5,3.5) [] {\(41\)};
    \node (CC-data) at (3.5,3.5) [] {\(16\)};
    \node (CD-data) at (4.5,3.5) [] {\(2\)};
    \node (CE-data) at (5.5,3.5) [] {};

    \node (DA-data) at (1.5,2.5) [] {\(5\)};
    \node (DB-data) at (2.5,2.5) [] {\(10\)};
    \node (DC-data) at (3.5,2.5) [] {\(14\)};
