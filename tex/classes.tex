...
\begin{document}
  \begin{tikzpicture}
    ...
    \node (AA-data) at (1.5,5.5) [] {\(409\)};
    \node (AB-data) at (2.5,5.5) [] {\(23\)};
    \node (AC-data) at (3.5,5.5) [] {\(1\)};
    \node (AD-data) at (4.5,5.5) [] {};
    \node (AE-data) at (5.5,5.5) [] {};

    \node (BA-data) at (1.5,4.5) [] {\(239\)};
    \node (BB-data) at (2.5,4.5) [] {\(45\)};
    \node (BC-data) at (3.5,4.5) [] {\(10\)};
    \node (BD-data) at (4.5,4.5) [] {\(1\)};
    \node (BE-data) at (5.5,4.5) [] {};

    \node (CA-data) at (1.5,3.5) [] {\(19\)};
    ...
    \node (DB-data) at (2.5,2.5) [] {\(6\)};
    \node (DC-data) at (3.5,2.5) [] {\(9\)};
    \node (DD-data) at (4.5,2.5) [] {\(4\)};
    \node (DE-data) at (5.5,2.5) [] {};

    \node (EA-data) at (1.5,1.5) [] {\(1\)};
    \node (EB-data) at (2.5,1.5) [] {};
    \node (EC-data) at (3.5,1.5) [] {\(5\)};
