...
\begin{document}
  \begin{tikzpicture}
    ...
    \node (AA-data) at (1.5,5.5) [] {\(734\)};
    \node (AB-data) at (2.5,5.5) [] {\(53\)};
    \node (AC-data) at (3.5,5.5) [] {\(7\)};
    \node (AD-data) at (4.5,5.5) [] {};
    \node (AE-data) at (5.5,5.5) [] {};

    \node (BA-data) at (1.5,4.5) [] {\(419\)};
    \node (BB-data) at (2.5,4.5) [] {\(92\)};
    \node (BC-data) at (3.5,4.5) [] {\(17\)};
    \node (BD-data) at (4.5,4.5) [] {\(1\)};
    \node (BE-data) at (5.5,4.5) [] {};

    \node (CA-data) at (1.5,3.5) [] {\(35\)};
    \node (CB-data) at (2.5,3.5) [] {\(37\)};
    \node (CC-data) at (3.5,3.5) [] {\(15\)};
    \node (CD-data) at (4.5,3.5) [] {\(3\)};
    \node (CE-data) at (5.5,3.5) [] {};

    \node (DA-data) at (1.5,2.5) [] {\(3\)};
    \node (DB-data) at (2.5,2.5) [] {\(12\)};
    \node (DC-data) at (3.5,2.5) [] {\(13\)};
    \node (DD-data) at (4.5,2.5) [] {\(2\)};
    \node (DE-data) at (5.5,2.5) [] {\(1\)};

    \node (EA-data) at (1.5,1.5) [] {\(1\)};
    \node (EB-data) at (2.5,1.5) [] {\(2\)};
    \node (EC-data) at (3.5,1.5) [] {\(10\)};
    \node (ED-data) at (4.5,1.5) [] {\(8\)};
    \node (EE-data) at (5.5,1.5) [] {\(1\)};
