...
\begin{document}
  \begin{tikzpicture}
    ...
    \node (AA-data) at (1.5,5.5) [] {\(572\)};
    \node (AB-data) at (2.5,5.5) [] {\(26\)};
    \node (AC-data) at (3.5,5.5) [] {\(7\)};
    \node (AD-data) at (4.5,5.5) [] {};
    \node (AE-data) at (5.5,5.5) [] {};

    \node (BA-data) at (1.5,4.5) [] {\(359\)};
    \node (BB-data) at (2.5,4.5) [] {\(73\)};
    \node (BC-data) at (3.5,4.5) [] {\(16\)};
    \node (BD-data) at (4.5,4.5) [] {};
    \node (BE-data) at (5.5,4.5) [] {};

    \node (CA-data) at (1.5,3.5) [] {\(38\)};
    \node (CB-data) at (2.5,3.5) [] {\(38\)};
    \node (CC-data) at (3.5,3.5) [] {\(11\)};
    \node (CD-data) at (4.5,3.5) [] {\(1\)};
    \node (CE-data) at (5.5,3.5) [] {};

    \node (DA-data) at (1.5,2.5) [] {\(5\)};
    \node (DB-data) at (2.5,2.5) [] {\(8\)};
