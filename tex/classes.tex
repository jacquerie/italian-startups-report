...
\begin{document}
  \begin{tikzpicture}
    ...
    \node (AA-data) at (1.5,5.5) [] {\(510\)};
    \node (AB-data) at (2.5,5.5) [] {\(32\)};
    \node (AC-data) at (3.5,5.5) [] {\(5\)};
    \node (AD-data) at (4.5,5.5) [] {};
    \node (AE-data) at (5.5,5.5) [] {};

    \node (BA-data) at (1.5,4.5) [] {\(300\)};
    \node (BB-data) at (2.5,4.5) [] {\(64\)};
    \node (BC-data) at (3.5,4.5) [] {\(17\)};
    \node (BD-data) at (4.5,4.5) [] {};
    \node (BE-data) at (5.5,4.5) [] {};

    \node (CA-data) at (1.5,3.5) [] {\(31\)};
    \node (CB-data) at (2.5,3.5) [] {\(27\)};
    \node (CC-data) at (3.5,3.5) [] {\(8\)};
    \node (CD-data) at (4.5,3.5) [] {};
